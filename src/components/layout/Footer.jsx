      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="mt-16 pt-8 border-t border-slate-200 flex flex-col sm:flex-row justify-between items-center text-sm text-slate-500">
          ...
          <div className="flex space-x-6 mt-4 sm:mt-0">
            {/* ✅ ENLLAÇOS CORREGITS SENSE .html */}
            <Link href="/avis-legal" className="hover:text-sky-500 hover:underline transition-colors">{t('footer.legalNotice')}</Link>
            <Link href="/politica-de-privacitat" className="hover:text-sky-500 hover:underline transition-colors">{t('footer.privacyPolicy')}</Link>
            <Link href="/politica-de-cookies" className="hover:text-sky-500 hover:underline transition-colors">{t('footer.cookiesPolicy')}</Link>
          </div>
        </div>
      </div>
    </footer>
